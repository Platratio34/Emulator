...
| `0x01`  | If `r[rg] == 0` GOTO `r[ra]`                  |
| `0x02`  | If `r[rg] <= 0` GOTO `r[ra]`                  |
| `0x03`  | If `r[rg] > 0` GOTO `r[ra]`                   |
| `0x04`  | If `r[rg] != 0` GOTO `r[ra]`                  |
|---------|-----------------------------------------------|
| `0x08`  | Unconditional GOTO `pPtr + ra`                |
| `0x09`  | If `r[rg] == 0` GOTO `pPtr + ra`              |
| `0x0a`  | If `r[rg] <= 0` GOTO `pPtr + ra`              |
| `0x0b`  | If `r[rg] > 0` GOTO `pPtr + ra`               |
| `0x0c`  | If `r[rg] != 0` GOTO `pPtr + ra`              |
|---------|-----------------------------------------------|
| `0x10`  | Unconditional GOTO `r[ra]`, push `pPtr`       |
| `0x11`  | If `r[rg] == 0` GOTO `r[ra]`, push `pPtr`     |
| `0x12`  | If `r[rg] <= 0` GOTO `r[ra]`, push `pPtr`     |
| `0x13`  | If `r[rg] > 0` GOTO `r[ra]`, push `pPtr`      |
| `0x14`  | If `r[rg] != 0` GOTO `r[ra]` , push `pPtr`    |
|---------|-----------------------------------------------|
| `0x18`  | Unconditional GOTO `pPtr + ra`, push `pPtr`   |
| `0x19`  | If `r[rg] == 0` GOTO `pPtr + ra`, push `pPtr` |
| `0x1a`  | If `r[rg] <= 0` GOTO `pPtr + ra`, push `pPtr` |
| `0x1b`  | If `r[rg] > 0` GOTO `pPtr + ra`, push `pPtr`  |
| `0x1c`  | If `r[rg] != 0` GOTO `pPtr + ra`, push `pPtr` |
|---------|-----------------------------------------------|
| `0x20`  | Unconditional GOTO `stack.pop`                |
| `0x21`  | If `r[rg] == 0` GOTO `stack.pop`              |
| `0x22`  | If `r[rg] <= 0` GOTO `stack.pop`              |
| `0x23`  | If `r[rg] > 0` GOTO `stack.pop`               |
| `0x24`  | If `r[rg] != 0` GOTO `stack.pop`              |
...
| `SET (FORCE) <EQ\|LEQ\|GT\|NEQ> [rg] [rd]`                |     | Conditionally sets `r[rg]` to `0x1` based on the value of `r[rg]` |       |
