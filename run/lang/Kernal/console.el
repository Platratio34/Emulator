...
namespace Kernal {
    ...
    public static void print(char* str, int32 len) {
        asm("LOAD MEM r1 Kernal.CONSOLE_OUT");
        asm("COPY r15 r2\nINC r2 -16\nLOAD MEM r2 r2"); // str
        asm("COPY r15 r3\nINC r3 -12\nLOAD MEM r3 r3"); // len
    ...
    public static void read(char* buffer, int32 bufferSize, out int32& count) {
        ...
        asm("COPY r2 r4\nCOPY r15 r5\nINC r5 -20\n:Kernal.read_char*_int32_l0"); // r4 is now i; r5 is not &buffer
        ...
        asm("GOTO EQ r1 :Kernal.read_char*_int32_end"); // skip if no space remaining
