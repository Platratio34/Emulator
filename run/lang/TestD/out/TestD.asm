...
// Releasing r1
// 0 38:14
#line run\lang\TestD\kalloc.el 38:14
// Reserving r1
// Reserving r2
SUB r2 r15 12
// Reserving r2
...
// Releasing r1
// 0 41:14
#line run\lang\TestD\kalloc.el 41:14
// Reserving r1
// Reserving r2
// Reserving r2
...
// 1 42:14
#line run\lang\TestD\kalloc.el 42:14
// Reserving r1
// Reserving r2
...
// 2 43:14
#line run\lang\TestD\kalloc.el 43:14
// Reserving r1
// Reserving r2
SUB r2 r15 12
// Reserving r2
...
COPY rStack r15
// 0 14:10
#line run\lang\TestD\kalloc.el 14:10
// Reserving r1
// Reserving r1
// Reserving r2
// Releasing r2
...
// 1 15:10
#line run\lang\TestD\kalloc.el 15:10
// Reserving r1
// Reserving r1
LOAD MEM r1 r15
INC r1 -32
...
// Releasing r1
// 0 16:14
#line run\lang\TestD\kalloc.el 16:14
// Reserving r1
LOAD r1 0 // nullptr
// Reserving r2
SUB r2 r15 12
...
#lineend
:if_end_2
//  if(cPages >= MAX_BLOCKS) {return nullptr;}
...
// Releasing r1
// 0 20:14
#line run\lang\TestD\kalloc.el 20:14
// Reserving r1
// Reserving r2
ADD r2 r15 4
// Reserving r2
...
// 4 22:10
#line run\lang\TestD\kalloc.el 22:10
// Reserving r1
ADD r1 r15 4
// Reserving r1
LOAD MEM r1 r1
...
// 7 27:10
#line run\lang\TestD\kalloc.el 27:10
// Reserving r1
// Reserving r2
// Reserving r2
LOAD r1 1 // 1
...
// 10 30:10
#line run\lang\TestD\kalloc.el 30:10
// Reserving r1
ADD r1 r15 8
// Reserving r1
LOAD MEM r1 r1 // addr
...
// 1 47:14
#line run\lang\TestD\CharaterDisplay.el 47:14
// Reserving r1
// Reserving r2
SUB r2 r15 20
// Reserving r2
...
// 1 65:10
#line run\lang\TestD\console.el 65:10
// Reserving r1
LOAD r1 Console.CONSOLE_IN_COUNT
// Reserving r1
...
// 2 66:10
#line run\lang\TestD\console.el 66:10
// Reserving r1
SUB r1 r15 12
// Reserving r1
LOAD MEM r1 r1
...
// Releasing r1
// 0 67:14
#line run\lang\TestD\console.el 67:14
// Reserving r1
// Reserving r2
// Reserving r2
// Releasing r1
...
// 3 69:10
#line run\lang\TestD\console.el 69:10
// Reserving r1
LOAD r1 0 // 0
#stackVar int32 i
STACK PUSH r1
...
// 4 70:10
#line run\lang\TestD\console.el 70:10
:while_condition_22
// Reserving r1
ADD r1 r15 4
// Reserving r1
...
// Releasing r1
// 0 71:14
#line run\lang\TestD\console.el 71:14
// Reserving r1
// Reserving r2
SUB r2 r15 16
// Reserving r2
...
// 1 73:14
#line run\lang\TestD\console.el 73:14
// Reserving r1
// Reserving r2
ADD r2 r15 4
// Reserving r2
...
// 5 75:10
#line run\lang\TestD\console.el 75:10
// Reserving r1
ADD r1 r15 4
// Reserving r1
LOAD MEM r1 r1
...
// 1 49:10
#line run\lang\TestD\console.el 49:10
COPY r15 r2
INC r2 -12
LOAD MEM r2 r2
//  asm("COPY r15 r2\nINC r2 -12\nLOAD MEM r2 r2");
...
// 2 50:10
#line run\lang\TestD\console.el 50:10
COPY rStack r3
...
// 3 51:10
#line run\lang\TestD\console.el 51:10
LOAD r4 10
LOAD r5 0x30
LOAD r6 0x0
//  asm("LOAD r4 10\nLOAD r5 0x30\nLOAD r6 0x0");
...
// 8 56:10
#line run\lang\TestD\console.el 56:10
INC r3 -1
//  asm("INC r3 -1");
...
// 10 58:14
#line run\lang\TestD\console.el 58:14
...
// 12 60:10
#line run\lang\TestD\console.el 60:10
STORE BYTE 0x0 r2
...
// 3 19:14
#line run\lang\TestD\console.el 19:14
LOAD MEM BYTE r3 r2
...
// 5 21:10
#line run\lang\TestD\console.el 21:10
:printStr_l1_exit
...
// 3 28:10
#line run\lang\TestD\console.el 28:10
:printStr_len
//  asm(":printStr_len");
...
// 1 11:10
#line run\lang\TestD\console.el 11:10
COPY r15 r2
INC r2 -12
LOAD MEM BYTE r2 r2
//  asm("COPY r15 r2\nINC r2 -12\nLOAD MEM BYTE r2 r2");
...
// 2 12:10
#line run\lang\TestD\console.el 12:10
STORE BYTE r2 r1
...
// 2 36:10
#line run\lang\TestD\console.el 36:10
COPY r15 r2
INC r2 -12
LOAD MEM r2 r2
//  asm("COPY r15 r2\nINC r2 -12\nLOAD MEM r2 r2");
...
// 3 37:10
#line run\lang\TestD\console.el 37:10
LOAD r3 0xf
LOAD r6 0xa
//  asm("LOAD r3 0xf\nLOAD r6 0xa");
...
// 8 42:14
#line run\lang\TestD\console.el 42:14
:intToHex_gt
//  asm(":intToHex_gt");
...
COPY rStack r15
// 0 166:10
#line run\lang\TestD\testd.el 166:10
// Reserving r1
// Reserving r1
...
// 1 167:10
#line run\lang\TestD\testd.el 167:10
LOAD rIC 0
//  asm("LOAD rIC 0");

// 2 168:10
#line run\lang\TestD\testd.el 168:10
#stackVar char[9] str
STACK INC 12
//  char[9] str;

// 3 169:10
#line run\lang\TestD\testd.el 169:10
// Reserving r1
// Reserving r2
ADD r2 r15 4
// Reserving r2
...
// 4 170:10
#line run\lang\TestD\testd.el 170:10
// Reserving r1
// Reserving r1
LOAD MEM r1 r15
INC r1 -255
...
// 5 174:10
#line run\lang\TestD\testd.el 174:10
// Reserving r1
// Reserving r1
LOAD MEM r1 r15
LOAD r2 -256
...
// Releasing r1
// 0 175:14
#line run\lang\TestD\testd.el 175:14
// Reserving r1
// Reserving r1
LOAD MEM r1 r15
LOAD r2 255
...
// 1 176:14
#line run\lang\TestD\testd.el 176:14
// Reserving r1
ADD r1 r15 16
// Reserving r1
LOAD MEM r1 r1
...
// 4 183:14
#line run\lang\TestD\testd.el 183:14
// Reserving r1
ADD r1 r15 16
// Reserving r1
LOAD MEM r1 r1 // i
...
// 5 184:14
#line run\lang\TestD\testd.el 184:14
// Reserving r1
ADD r1 r15 20
// Reserving r1 // &str
STACK PUSH r1
...
// 6 185:14
#line run\lang\TestD\testd.el 185:14
// Reserving r1
LOAD r1 0 // 0
STACK PUSH r1
LOAD r1 23 // 23
...
// 7 186:14
#line run\lang\TestD\testd.el 186:14
GOTO :func_exit_TestD.onInterrupt
//  return;
...
// Releasing r1
// 0 189:14
#line run\lang\TestD\testd.el 189:14
// Reserving r1
// Reserving r1
LOAD MEM r1 r15
LOAD r2 255
...
// 1 190:14
#line run\lang\TestD\testd.el 190:14
// Reserving r1
ADD r1 r15 16
// Reserving r1
LOAD MEM BYTE r1 r1
...
// Releasing r1
// 0 191:18
#line run\lang\TestD\testd.el 191:18
// Reserving r1
// Reserving r2
// Reserving r2
...
// 1 192:18
#line run\lang\TestD\testd.el 192:18
// Reserving r1
// Reserving r2
// Reserving r2
...
// 2 194:14
#line run\lang\TestD\testd.el 194:14
// Reserving r1
ADD r1 r15 16
// Reserving r1
LOAD MEM BYTE r1 r1
...
// Releasing r1
// 0 195:18
#line run\lang\TestD\testd.el 195:18
GOTO :func_exit_TestD.onInterrupt
//  return;
...
// 3 197:14
#line run\lang\TestD\testd.el 197:14
// Reserving r1
// Reserving r2
// Reserving r2
LOAD r2 &TestD.inputBuffer
...
// 10 204:10
#line run\lang\TestD\testd.el 204:10
// Reserving r1
LOAD r1 '\n' // \n
STACK PUSH BYTE r1
// Releasing r1
...
// 0 211:10
#line run\lang\TestD\testd.el 211:10
// Reserving r1
...
// 1 212:10
#line run\lang\TestD\testd.el 212:10
:while_condition_38
// Reserving r1
LOAD r1 Peripheral.TIMERS
// Reserving r1
...
// 3 148:14
#line run\lang\TestD\testd.el 148:14
...
// 5 150:14
#line run\lang\TestD\testd.el 150:14
...
// Releasing r1
// 0 120:18
#line run\lang\TestD\testd.el 120:18
// Reserving r1
// Reserving r2
// Reserving r2
...
// 1 121:18
#line run\lang\TestD\testd.el 121:18
// Reserving r1
STACK INC 4
// Reserving r2
...
// Releasing r1
// 0 122:22
#line run\lang\TestD\testd.el 122:22
// Reserving r1
LOAD r1 0 // false
// Reserving r2
SUB r2 r15 12
...
:if_else_40
// 0 126:18
#line run\lang\TestD\testd.el 126:18
// Reserving r1
// Reserving r2
// Reserving r2
LOAD r2 &TestD.tempCmd
...
// 1 127:18
#line run\lang\TestD\testd.el 127:18
// Reserving r1
// Reserving r2
// Reserving r2
LOAD r2 &TestD.tempCmdI
...
COPY rStack r15
// 0 223:10
#line run\lang\TestD\testd.el 223:10
// Reserving r1
LOAD r1 2000 // 2000
// Reserving r2
SUB r2 r15 12
...
// 26 57:10
#line run\lang\TestD\testd.el 57:10
// Reserving r1
LOAD r1 '\n' // \n
STACK PUSH BYTE r1
// Releasing r1
...
// 1 72:14
#line run\lang\TestD\testd.el 72:14
...
// 4 75:14
#line run\lang\TestD\testd.el 75:14
// Reserving r1
ADD r1 r15 36
// Reserving r1
LOAD MEM r1 r1 // fh
...
// 3 137:10
#line run\lang\TestD\testd.el 137:10
// Reserving r1
STACK INC 4
// Reserving r2
// Reserving r2
...
// 0 218:10
#line run\lang\TestD\testd.el 218:10
// Reserving r1
// Reserving r2
SUB r2 r15 12
// Reserving r2
...
// 1 219:10
#line run\lang\TestD\testd.el 219:10
// Reserving r1
// Reserving r2
SUB r2 r15 12
// Reserving r2
