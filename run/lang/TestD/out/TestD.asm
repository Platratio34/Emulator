...
// Reserving r2
// Reserving r3
LOAD r3 &TestD.inputBufferWrite
// Reserving r3
LOAD MEM r3 r3 // inputBufferWrite
ADD r2 r2 r3
// Releasing r3
// Releasing r1
LOAD r1 '\n' // \n
...
// 0 208:10
#line run\lang\TestD\testd.el 208:10
:while_condition_33
// Reserving r1
COPY r15 r1
INC r1 -12
...
// Reserving r2
LOAD MEM r2 r2 // inputBufferRead
ADD r1 r1 r2
// Releasing r2
...
// Reserving r2
// Reserving r3
LOAD r3 &TestD.tempCmdI
// Reserving r3
LOAD MEM r3 r3 // tempCmdI
ADD r2 r2 r3
// Releasing r3
// Releasing r1
LOAD r1 0 // 0
...
STACK POP BYTE r1
// Releasing r2
GOTO NEQ r1 :if_end_36 // !processCommand()
// Releasing r1
// 0 122:22
...
// 0 214:10
#line run\lang\TestD\testd.el 214:10
// Reserving r1
// Reserving r2
COPY r15 r2
INC r2 -12
